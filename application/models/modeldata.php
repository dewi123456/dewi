...
class Modeldata extends CI_Model{
    ...
    public function update_peminjaman($id_peminjam,$nama_peminjam,$kelas,$nama_buku,$tanggal_pinjam,$tanggal_kembali,$tanggal_pengembalian,$telat,$denda,$jumlah_pinjam,$petugas)
    {
        $isidata=array(
