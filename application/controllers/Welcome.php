...
class Welcome extends CI_Controller {
	...
	public function updatepeminjaman()
	{
		...
		$this->load->model('Modeldata');
		$this->Modeldata->update_peminjaman($id_peminjam,$nama_peminjam,$kelas,$nama_buku,$tanggal_pinjam,$tanggal_kembali,$tanggal_pengembalian,$telat,$denda,$jumlah_pinjam,$petugas);
		redirect('Welcome/peminjaman');
	}
}